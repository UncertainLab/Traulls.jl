# Problem 5.17 from Lksan & Vlcek collection (1999)
# Chained HS52 problem

function lv517(n::Int=100)
    ...
    function jr!(J, x)
        ...
        for i = 1:N
            J[i, 4i-3] = 4
            J[i, 4i-2] = -1
            J[N+i, 4i-2] = 2 * (x[4i-2] + x[4i-1] - 2)
            J[N+i, 4i-1] = 2 * (x[4i-2] + x[4i-1] - 2)
            J[2N+i, 4i] = 1
            J[3N+i, 4i+1] = 1
        end
        return
