...
\begin{document}
	...
	\begin{equation}
		...
		\end{aligned}
	\end{equation}
	where $\|\cdot\|$ denotes the $\ell_2$ normThe residuals $r\colon \RR^n \to \RR^{n_r}$ and constraints $c\colon \RR^n \to \RR^{n_c}$ functions are assumed to be twice continuously differentiable with respective Jacobian $J$ and $C$. The set $\Omega$ consists of linear constraints and is defined as
